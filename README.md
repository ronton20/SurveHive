...
- Floating health bars above enemies and floating damage-number popups on hit.
...
- Not yet built: other worlds (Garden/Woods/City/Alien Ship), difficulty/curve tuning pass, mobile sanity pass, and a localization seam. See `CHANGELOG.md` for the release history (the phased build push, Phases 0–5A, is complete) and `TODO.md` for the open backlog and suggested implementation order.
