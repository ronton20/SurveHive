...
- **Run results** (Phase 3): both the death and victory screens show the run summary — time survived, kills, level reached, and honey banked — and the run's currency banks into the meta store on both paths (feeds the Phase 4 shop). Restart with R / tap.
